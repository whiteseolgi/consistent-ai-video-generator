<script lang="ts">
  ...
  const videoModels: VideoModel[] = ['veo-3.0-fast-generate-preview', 'veo-3.0-generate-preview', 'runway'];
    ...
    <div class="card-body space-y-6">
      ...
      <div>
        ...
        <div class="flex gap-2">
          ...
          {#if existingEntitySets.length > 0}
            <select
              onchange={(e) => entitySetName = e.currentTarget.value}
      ...
      <div class="grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          <select
            id="imageQuality"
            bind:value={defaultImageQuality}
            class="select select-bordered w-full"
          >

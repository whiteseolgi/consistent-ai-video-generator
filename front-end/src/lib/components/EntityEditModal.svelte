<script lang="ts">
  ...
  const imageModels: ImageModel[] = ['gpt-image-1'];
...
<div class="fixed inset-0 flex items-center justify-center p-8" style="position: fixed !important; top: 0 !important; left: 0 !important; right: 0 !important; bottom: 0 !important; z-index: 10000 !important; background: rgba(0,0,0,0.5) !important;" onclick={onclose}>
  <!-- Modal Content -->
  <div class="relative w-full mx-8 shadow-2xl" onclick={(e) => e.stopPropagation()} style="background: white !important; border-radius: 8px !important; border: 1px solid #e5e7eb !important; max-width: 1280px !important; max-height: 90vh !important; overflow-y: auto !important; padding: 32px !important; display: block !important;">
      ...
      <div class="space-y-4">
        ...
        <div>
          ...
          <select
            bind:value={type}
            disabled={!isAdd}
            class="select select-bordered w-full {!isAdd ? 'select-disabled' : ''}"
          >
